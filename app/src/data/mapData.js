...
export const PERIODS = {
  spring_autumn: {
    label: "春秋 · 公元前 7 世纪",
    states: [
      { name: "晋", color: "#2B4490", polygon: [[110.5,39.0],[112.5,39.5],[114.0,38.5],[114.0,37.0],[113.0,35.5],[111.5,35.0],[110.0,35.5],[109.5,37.0],[110.0,38.5]] },
      { name: "齐", color: "#C8893A", polygon: [[116.5,38.0],[118.5,37.8],[120.5,37.5],[120.7,36.0],[119.0,35.0],[117.0,35.2],[116.0,36.5]] },
      { name: "秦", color: "#6B3F1D", polygon: [[104.5,36.0],[107.0,35.5],[109.0,34.5],[108.5,33.5],[106.5,33.5],[104.5,34.0],[103.5,35.0]] },
      { name: "楚", color: "#C41E24", polygon: [[110.0,32.5],[113.0,33.0],[115.5,32.5],[117.5,31.5],[117.5,29.5],[115.0,28.5],[112.0,29.0],[109.5,30.5]] },
      { name: "鲁", color: "#8B572A", polygon: [[116.0,36.0],[118.0,36.0],[118.0,34.7],[116.5,34.5],[115.8,35.2]] },
      { name: "宋", color: "#6B8E5A", polygon: [[114.5,35.0],[116.0,35.0],[116.5,33.8],[115.0,33.5],[114.0,34.2]] },
      { name: "卫", color: "#7BA098", polygon: [[114.0,36.2],[115.5,36.0],[115.7,35.0],[114.2,35.0]] },
      { name: "郑", color: "#A39580", polygon: [[113.0,34.8],[114.5,34.8],[114.5,34.0],[113.0,34.0]] },
      { name: "曹", color: "#C8A465", polygon: [[114.8,35.5],[115.6,35.6],[115.6,35.0],[114.8,35.0]] },
      { name: "吴", color: "#4A6FB0", polygon: [[118.5,32.5],[120.5,32.5],[121.0,30.5],[119.5,30.0],[118.0,31.0]] },
    ],
    cities: [
  ...
  warring_states: {
    label: "战国 · 公元前 3 世纪",
    states: [
      { name: "秦", color: "#6B3F1D", polygon: [[100.0,38.0],[105.0,38.0],[108.0,37.5],[110.0,36.5],[110.5,35.0],[111.5,34.0],[110.5,33.0],[108.0,32.5],[105.0,32.5],[103.0,33.5],[101.0,34.5],[100.0,36.0]] },
      { name: "楚", color: "#C41E24", polygon: [[110.5,33.5],[113.5,33.8],[117.0,33.5],[120.5,32.5],[121.5,30.5],[120.5,28.0],[117.0,26.5],[113.0,26.5],[110.5,28.0],[108.5,30.5],[109.0,32.5]] },
      { name: "齐", color: "#C8893A", polygon: [[116.0,38.5],[118.5,38.2],[120.7,37.5],[120.5,35.5],[118.5,34.7],[116.5,35.0],[115.5,36.5],[115.8,38.0]] },
      { name: "燕", color: "#3B3328", polygon: [[114.5,42.0],[118.0,42.5],[121.5,41.5],[122.0,40.0],[120.0,39.5],[117.0,39.5],[115.0,40.0],[114.0,41.0]] },
      { name: "赵", color: "#7BA098", polygon: [[111.0,40.0],[114.5,40.0],[115.5,38.5],[115.0,37.0],[113.5,36.5],[112.0,36.5],[110.5,37.5],[110.5,39.0]] },
      { name: "魏", color: "#4A6FB0", polygon: [[111.0,35.5],[114.0,35.8],[115.5,35.5],[115.5,34.0],[113.5,33.7],[112.0,34.0],[111.0,34.5]] },
      { name: "韩", color: "#8B572A", polygon: [[112.5,34.7],[114.5,34.5],[114.5,33.5],[112.5,33.5],[112.0,34.2]] },
    ],
    cities: [
  ...
  chu_han: {
    ...
    states: [
      { name: "西楚", color: "#C41E24", polygon: [[112.0,35.0],[116.0,35.5],[120.5,33.0],[121.0,30.0],[117.0,28.0],[113.0,29.0],[111.0,31.5],[111.5,34.0]] },
      { name: "汉", color: "#2B4490", polygon: [[103.0,34.0],[107.5,34.0],[110.0,33.5],[111.0,32.0],[108.5,30.5],[105.0,31.0],[102.5,32.0]] },
      { name: "齐", color: "#C8893A", polygon: [[116.5,38.0],[120.5,37.5],[120.5,35.5],[117.0,35.5],[116.0,36.8]] },
    ],
    cities: [
